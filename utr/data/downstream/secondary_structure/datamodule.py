...
from utr.data.downstream.secondary_structure.dataset import SecondaryStructureDataset

from utr.utils.download import download_spot_rna_bprna, download_archiveII_fam_splits
...
def prepare_data(data_root):
        ...
        download_archiveII_fam_splits(
            data_root / "archiveII", train_dir_name=TRAIN_DIR_NAME,
            val_dir_name=VAL_DIR_NAME, test_dir_name=TEST_DIR_NAME
        )

        _data_prepared = True
if __name__ == "__main__":
    data_root = Path('./ss_data')
